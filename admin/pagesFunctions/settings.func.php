    ...
    function add_modo($name,$email,$role,$token){
        ...
        $message = '
            <html lang="en" style="font-family: sans-serif;">
                ...
                <body>
                    Voici votre identifiant et code unique à insérer sur <a href="http://localhost/mesprojets/blog-igloofood/admin/index.php?page=new">cette page</a>:
        ...
        $header .= 'From: meriem.barka@gmail.com' . "\r\n" . 'Reply-To: meriem.barka@laplateforme.io' . "\r\n" . 'X-Mailer: PHP/' . phpversion();
